...
(() => {
    ...
    describe('Testing tags optimization', () => {
        // it('debug tags optimization', done => {
        //     let svg = new SVG(fs.readFileSync('tests/files/w8-charge-battery.svg', 'utf8'), {minify: false});
        //
        //     Optimize(svg, {minify: false}).then(() => {
        //         console.log('After optimization:\n', svg.getContent());
        //         return Tags(svg);
        //     }).then(() => {
        //         console.log('After tags:\n', svg.getContent());
        //         svg.getEverything().then(result => {
        //             expect(result.svg).to.be.equal('');
        //             done();
        //         }).catch(err => {
        //             done(err);
        //         });
